...
struct Options
{
	Options() : options_("Valid options are", 120, 80)
	{
		...
		options_.add_options()
			...
			("rawfull", value<bool>(&rawfull)->default_value(true)->implicit_value(true),
			...
			("shutter", value<float>(&shutter)->default_value(20000),
			...
			("awb", value<std::string>(&awb)->default_value("fluorescent"),
